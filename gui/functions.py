...
def get_info():
    ...
    text.config(state='normal')
    text.insert('1.0', 
    "СПРАВКА ПО ИСПОЛЬЗОВАНИЮ ПРОГРАММЫ «ОВКС»\n\n"
    ...
    "   в) Откроется окно сохранения, и в выбранной папке появится файл network_viz.html.\n"
    "   г) Откройте этот HTML‑файл в любом современном браузере.\n\n"
    "6. ЧТО ДЕЛАТЬ, ЕСЛИ ИКОНКИ НЕ ОТОБРАЖАЮТСЯ?\n"
    "   • Убедитесь, что файлы изображений лежат в папке network_images рядом с программой.\n"
